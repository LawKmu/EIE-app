          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                @csrf
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="nom" name="nom" id="nom" aria-label="nom" aria-describedby="nom" value="{{ old('nom') }}">
                  @error('nom')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="prenom" name="prenom" id="prenom" aria-label="prenom" aria-describedby="prenom" value="{{ old('prenom') }}">
                  @error('prenom')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="matricule" name="matricule" id="matricule" aria-label="matricule" aria-describedby="matricule" value="{{ old('matricule') }}">
                  @error('matricule')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="CIN" name="CIN" id="CIN" aria-label="CIN" aria-describedby="CIN" value="{{ old('CIN') }}">
                  @error('CIN')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="phoneNumber" name="phoneNumber" id="phoneNumber" aria-label="phoneNumber" aria-describedby="phoneNumber" value="{{ old('phoneNumber') }}">
                  @error('phoneNumber')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="pole" name="pole" id="pole" aria-label="pole" aria-describedby="pole" value="{{ old('pole') }}">
                  @error('pole')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="groupe" name="groupe" id="groupe" aria-label="groupe" aria-describedby="groupe" value="{{ old('groupe') }}">
                  @error('groupe')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
